<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true"
    CodeFile="Add Commitee.aspx.cs" Inherits="Factory_Statistics_factorystatistics_Add_Commitee"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table border="2" style="z-index: 103; left: 292px; width: 306px; position: absolute;
        ...
        <tr>
            <td colspan="2">
                &nbsp;
                <asp:Label ID="Label1" runat="server" Text="Commitee Details" Style="z-index: 100;
                    left: 70px; position: absolute; top: 7px" Height="12px" Width="137px"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                &nbsp;
                <asp:Button ID="Button1" runat="server" Text="Submit" Style="z-index: 100; left: 95px;
                    position: absolute; top: 207px" OnClick="Button1_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
